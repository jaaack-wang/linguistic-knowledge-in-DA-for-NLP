...
class NgramLM:
    ...
    def __init__(self):
        self._unigram = readJson('../data/Unigram.json')
        self._bigram = readJson('../data/Bigram.json')
        self._trigram = readJson('../data/Fourgram.json')
        self._fourgram = readJson('../data/Trigram.json')
