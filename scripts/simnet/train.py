...
from utils import convert_example, load_dataset
...
parser.add_argument("--train_set_path", type=str, default="./train.txt", help="The path to the train set.")
parser.add_argument("--dev_set_path", type=str, default="./dev.txt", help="The path to the dev set.")
...
if __name__ == "__main__":
    ...
    # Loads dataset.
    train_ds, dev_ds = load_dataset(args.train_set_path), load_dataset(args.dev_set_path)
